...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white selection:bg-luxury-gold/20 overflow-x-hidden relative">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div className="relative z-10 text-left">
            ...
            <motion.h1
              ...
              className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-luxury-blue-mid leading-[0.9] mb-8"
            >
              Crafting Durable, <br />
      ...
      {/* [5] ADVANTAGE – PREMIUM HORIZONTAL SCROLL */}
      <section className="py-24 md:py-32 bg-white border-b border-luxury-divider overflow-hidden -mt-[43px] gpu-accelerate">
        <div className="max-w-7xl mx-auto">
          <FadeInWhenVisible>
            <div className="text-center mb-16 px-4">
              <span className="text-[10px] font-bold uppercase tracking-[0.6em] text-luxury-blue-mid mb-4 block">
                The Huecraft Advantage
              </span>
              <h2 className="font-serif text-4xl md:text-6xl font-bold text-luxury-blue-mid tracking-tighter">
                Why Choose <span className="text-luxury-gold italic font-light">Huecraft.</span>
              </h2>
            </div>
          </FadeInWhenVisible>
          ...
          <div className="relative -mx-4 px-4 lg:mx-0 lg:px-0">
            <div 
              className="flex lg:grid lg:grid-cols-3 gap-5 lg:gap-8 overflow-x-auto lg:overflow-visible pb-12 lg:pb-0 no-scrollbar snap-x snap-mandatory lg:snap-none cursor-grab active:cursor-grabbing lg:cursor-auto"
            ...
            >
              {[
                ...
                },
                {
                  icon: Layers,
                  title: "Turnkey Solutions",
                  desc: "End-to-end project management from initial consultation to final inspection."
                },
                {
                  icon: Zap,
                  title: "Clean Execution",
                  desc: "Dustless sanding and rigorous site protection protocols."
                }
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex-none w-[75vw] sm:w-[320px] md:w-[350px] lg:w-auto snap-start lg:snap-align-none"
                >
                  <motion.div
                    whileHover={{ y: -8 }}
                    whileTap={{ scale: 0.98 }}
                  ...
                  >
                    ...
                    <p className="relative z-10 text-xs md:text-sm font-medium text-luxury-gray leading-relaxed group-hover:text-luxury-gray-deep transition-colors duration-500">
                      {item.desc}
                    </p>
