            ...
            <div className="flex items-center justify-end z-10">
              ...
              <div className="md:hidden">
                <motion.button
                  ...
                  className="group relative flex h-10 w-10 items-center justify-center rounded-full bg-white border border-luxury-divider text-luxury-blue-mid shadow-premium-sm transition-all duration-300 hover:border-luxury-gold/30 hover:shadow-premium-md"
